...
urlpatterns = [
    ...
    url(r'^events/(?P<group_id>[0-9]+)/add_project/$', views.event_add_project, name='event_add_project'),
    url(r'^events/(?P<group_id>[0-9]+)/remove_project/$', views.event_delete_project, name='event_remove_project'),
