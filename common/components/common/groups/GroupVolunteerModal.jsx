...
import {TagDefinition} from "../../utils/GroupAPIUtils.js";
...
/**
 * Modal for volunteering to join a group
 */

class GroupVolunteerModal extends React.PureComponent<Props, State> {
  ...
  askForSendConfirmation(): void {
    metrics.logVolunteerClickVolunteerSubmit(CurrentUser.userID(), this.props.groupId);
  ...
  handleSubmit() {
    ...
    metrics.logVolunteerClickVolunteerSubmitConfirm(CurrentUser.userID(), this.props.groupId);
    groupAPIUtils.post("/volunteer/" + this.props.groupId + "/",
      {
        message: this.state.message,
        groupedEndDate: moment().utc().add(this.state.daysToVolunteerForOption.value, 'days').format(),
    ...
    return (
      <div>
        <ConfirmationModal
          ...
          message="Do you want to apply to this group?"
              ...
              <Form>
                <Form.Group>
                  ...
                  {_.isEmpty(this.props.positions) || (this.state.existingPositionOption && (this.state.existingPositionOption.value === OtherRoleOption.value))
                    ...
                    : null}
                  <Form.Label>How long do you expect to be able to contribute to this group?</Form.Label>
                  ...
                  <Form.Control as="textarea"
                    placeholder="I'm interested in helping with this group because..."
                    rows="4"
                    cols="50"
                    name="message"
                    maxLength="3000"
  ...
  _renderExistingPositionDropdown(): React$Node{
    ...
    <div className="form-group">
      <label htmlFor="group_technologies">Position to Apply For</label>
        <Select
  ...
  _renderOtherRoleDropdown(): React$Node{
    return (
      <div className="form-group">
        <label htmlFor="group_technologies">Role You are Applying For</label>
        <TagSelector
...
export default GroupVolunteerModal;
