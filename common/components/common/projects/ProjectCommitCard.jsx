      ...
      <div className="ProjectCommitCard-container">
        <div className="ProjectCommitCard-line ProjectCommitCard-author-line">
          <div className="ProjectCommitCard-avatar">
            <img
              src={user_avatar_link || `https://github.com/identicons/${user_name || 'null'}.png`}
          ...
          <div className="ProjectCommitCard-date">committed {moment(commit_date).fromNow()}</div>
        </div>
        <div className="ProjectCommitCard-line">
          <div className="ProjectCommitCard-commit-icon">
            <svg viewBox="0 0 14 16" version="1.1" width="21" height="24" aria-hidden="true"><path fill-rule="evenodd" d="M10.86 7c-.45-1.72-2-3-3.86-3-1.86 0-3.41 1.28-3.86 3H0v2h3.14c.45 1.72 2 3 3.86 3 1.86 0 3.41-1.28 3.86-3H14V7h-3.14zM7 10.2c-1.22 0-2.2-.98-2.2-2.2 0-1.22.98-2.2 2.2-2.2 1.22 0 2.2.98 2.2 2.2 0 1.22-.98 2.2-2.2 2.2z"></path></svg>
          </div>
        ...
        <div className="ProjectCommitCard-line ProjectCommitCard-branch-line">
          ...
          in repo
          <a href={`https://github.com/${repo_name}`} target="_blank" rel="noopener">{repo_name}</a>
          on GitHub
        </div>
      </div>
    );
